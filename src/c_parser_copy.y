...
%token T_INC_OP T_DEC_OP LEFT_OP RIGHT_OP T_LE_OP T_GE_OP T_GT T_LT T_EQUALTO T_NOT_EQUALTO

%token T_TIMES T_PLUS T_MINUS T_DIVIDE T_NOT T_XOR_OP
...
%token CASE DEFAULT T_IF T_ELSE SWITCH T_WHILE DO FOR CONTINUE BREAK T_RETURN T_FOR
...
%type <expr> PARAMETER_LIST STRUCT_DECLARATION_LIST STRUCT_DECLARATOR SPECIFIER_QUALIFIER_LIST IDENTIFIER_LIST DIRECT_DECLARATOR ENUMERATOR_LIST

%type <expr> LABELED_STATEMENT STRUCT_DECLARATION POINTER STRUCT_DECLARATOR_LIST PARAMETER_DECLARATION ENUMERATOR ASSIGNMENT_EXPRESSION TRANSLATION_UNIT POSTFIX_EXPRESSION

%type <number> T_INTEGER

%type <string> T_VARIABLE T_DOUBLE T_FLOAT T_INT T_UNSIGNED T_CHAR T_IF T_ELSE T_WHILE T_RETURN UNARY T_VOID T_TYPEDEF T_PLUS T_MINUS T_NOT T_AND_OP T_TIMES T_ASS SUB_ASSIGN LEFT_ASSIGN RIGHT_ASSIGN AND_ASSIGN T_MOD

%type <string> T_LOGICAL_AND_OP T_LOGICAL_OR_OP T_LE_OP T_GE_OP T_GT T_LT T_EQUALTO T_NOT_EQUALTO ASSIGNMENT_OPERATOR TYPE_SPECIFIER DECLARATION_SPECIFIERS MUL_ASSIGN DIV_ASSIGN XOR_ASSIGN OR_ASSIGN ADD_ASSIGN MOD_ASSIGN
...
POSTFIX_EXPRESSION
	...
	| POSTFIX_EXPRESSION T_LSBRACKET EXPR T_RSBRACKET {}
...
DECLARATION_SPECIFIERS
	: T_TYPEDEF { $$ = $1;}
	| T_TYPEDEF DECLARATION_SPECIFIERS { $$ = new std::string(*$1 +" " + *$2);}
	| TYPE_SPECIFIER { $$ = $1;}
...
ENUM_SPECIFIER
	: ENUM T_LCBRACKET ENUMERATOR_LIST T_RCBRACKET {}
	| ENUM T_VARIABLE T_LCBRACKET ENUMERATOR_LIST T_RCBRACKET {}
	| ENUM T_VARIABLE {}
	;
...
ENUMERATOR
	: T_VARIABLE { $$ = new Variable(*$1);}
	| T_VARIABLE T_ASS LOGICAL_OR_EXPRESSION {}
	;
...
DIRECT_DECLARATOR
	...
	| DIRECT_DECLARATOR T_LSBRACKET LOGICAL_OR_EXPRESSION T_RSBRACKET {}
...
LABELED_STATEMENT
	...
	| CASE LOGICAL_OR_EXPRESSION T_COLON STATEMENT {  }
	| DEFAULT T_COLON STATEMENT {  }
	;
...
CONDITIONAL
	...
	| SWITCH T_LBRACKET EXPR T_RBRACKET STATEMENT {  $$ = $5; }
	;
...
ITERATION_STATEMENT
	...
	| FOR T_LBRACKET EXPRESSION_STATEMENT EXPRESSION_STATEMENT EXPR T_RBRACKET STATEMENT {  }
	;

JUMP
	: CONTINUE T_SEMICOLON {  $$ = NULL; }
	| BREAK T_SEMICOLON {  $$ = NULL; }
...
FUNCTION_DEFINITION
	...
	| DECLARATION_SPECIFIERS DECLARATOR COMPOUND_STATEMENT {  $$ = new FunctionDec(*$1, $2, $3);}
